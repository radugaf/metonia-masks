(function($) {
  ...
  $('#verticalHeader').slimScroll({alwaysVisible: true, railVisible: true, railColor: '#343434'});
  $('#miniCart').slimScroll({alwaysVisible: false, railVisible: true, railColor: '#343434'});
  ...
  function doAnimations(elements) {
    ...
    elements.each(function() {
      ...
      $this.css({'animation-delay': $animationDelay, 'animation-duration': $animationDuration});
  ...
  $('.post-gallery').slick({slidesToShow: 1, slidesToScroll: 1, arrows: true, prevArrow: '<span class="slick-btn slick-prev"><i class="fa fa-angle-left"></i></span>', nextArrow: '<span class="slick-btn slick-next"><i class="fa fa-angle-right"></i></span>'});
